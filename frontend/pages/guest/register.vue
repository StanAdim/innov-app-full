...
>
  ...
  >
    ...
    <p class="mb-6 [ text-sm text-[#1A2421]/70 text-opacity-50 ]">
      Enter a valid user Details in the fields below to Register new user.
    </p>

    <label
      for="name"
      class="relative block mb-4 text-black/50 focus-within:text-[#333]">
      <svg class="label-icon transition pointer-events-none [ w-6 h-6 ] [ absolute top-1/2 left-3 ] [ transform -translate-y-1/2 ]"
